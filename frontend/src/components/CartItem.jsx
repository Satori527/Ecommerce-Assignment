...
const CartItem = ({ item }) => {
	...
	return (
		<div className='rounded-lg border p-4 shadow-sm border-[#39495f] bg-[rgba(34,44,59,0.7)] md:p-6'>
			<div className='space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0'>
						...
						<button
							className='inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-md border
							 border-gray-600 bg-gray-700 hover:bg-gray-600 focus:outline-none focus:ring-2
							  focus:ring-teal-500'
							onClick={() => updateQuantity(item.productId, item.quantity - 1, false)}
						>
				...
				<div className='w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md'>
					...
					<p className='text-sm text-gray-400'>{item.description.substring(0, 130)}...</p>
